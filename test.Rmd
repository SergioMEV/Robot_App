...
```{r}
 if(deathsPerMillion <= deathsQuantile[2]){#first quartile
      robot1 <- image_fill(robot, "lightpink", point = "+50+130", fuzz = 0)
 }else if(deathsPerMillion <= deathsQuantile[3]){#second quartile
      robot1 <- image_fill(robot, "brown1", point = "+50+130", fuzz = 0)
      ...
      robot1 <- image_fill(robot, "red4", point = "+50+130", fuzz = 0)
 }
